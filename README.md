...
- Adding a new project to portfolios. 
...
- Step 5: Can be used css frameworks like Bootstrap, Semantic UI, Material UI.

- Step 6: Add project gif to project and README.md file.

## Notes

- Can be added additional functionalities to the app.
